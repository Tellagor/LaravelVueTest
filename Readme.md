...
Если бы было больше времени: докрутил бы прогресс-бар парсинга по числу отзывов, добавил ротацию User-Agent (это дёшево и просто), причесал бы CSS, и настроил docker-compose для одноко́мандного локального запуска.